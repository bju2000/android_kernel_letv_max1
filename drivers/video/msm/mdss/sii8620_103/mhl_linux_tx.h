...
extern struct regulator *mhl_reg;

/* System GPIOs assigned to control various starter kit signals */
#define GPIO_MHL_INT				954	/* W_INT */
#define GPIO_BB_RESET				917	/* P_BB_RST# */
#define GPIO_BB_FW_WAKE                   972
#define GPIO_BB_POWER_1V0                14

#define GPIO_BB_ID_SEL                        980
/*
...
struct qualcomm_platform_data {
	...
	/* to store the device pointer of qualcomm hdmi Tx*/
...
struct mhl_dev_context {
	...
	struct notifier_block mhl_notifier;
	...
	int mhl_mode;
	struct wake_lock mhl_on_wake_lock;
...
#define DEV_FLAG_COMM_MODE	0x02	/* Halt INTR processing */
	u8 dev_type;
#define DEV_TYPE_TV			0x00
#define DEV_TYPE_ARMET		0x01
...
#define MHL_STATE_APPLICATION_RAP_BUSY	0x4000	/* application has indicated
	...
	int sequence;
	void			*hpd_timer;/*Garyyuan  add for HPD timer test*/
