...
#define REG_H_RESH                                 (TX_PAGE_0, 0x3B)

#define MSK_H_RESH_HRESOUT_7_0                     (0x1F << 0)

/*----------------------------------------------------------------------------*/
/* 0x3C Video V Refresh Low Register                       (Default: 0x00)    */
#define REG_V_RESL                                 (TX_PAGE_0, 0x3C)

#define MSK_V_RESL_HRESOUT_7_0                      (0xFF << 0)

/*----------------------------------------------------------------------------*/
/* 0x3D Video V Refresh High Register                      (Default: 0x00)    */
#define REG_V_RESH                                 (TX_PAGE_0, 0x3D)

#define MSK_V_RESH_HRESOUT_7_0                     (0x0F << 0)
