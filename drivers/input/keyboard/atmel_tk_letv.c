...
static DEVICE_ATTR(update_fw, S_IRWXUGO/*S_IWUSR*/ , NULL, ts_update_fw_store);
static DEVICE_ATTR(debug_v2_enable, S_IRWXUGO/*S_IWUSR | S_IRUSR*/, NULL, ts_debug_v2_enable_store);
...
static DEVICE_ATTR(bootloader, S_IWUSR | S_IRUSR, ts_bootloader_show,
			ts_bootloader_store);
static DEVICE_ATTR(reg, S_IRWXUGO/* S_IWUSR | S_IRUSR*/, ts_dbg_reg_show,
			ts_dbg_reg_store);
