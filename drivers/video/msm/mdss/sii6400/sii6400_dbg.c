 ...
 *   dev_attr_nv_size
 */
static DEVICE_ATTR(test_cmd, (S_IWUGO), NULL, sys_test_cmd);
static DEVICE_ATTR(reboot, (S_IWUGO), NULL, sys_reboot_sii6400);
static DEVICE_ATTR(load, (S_IWUGO), NULL, sys_load_sii6400);
static DEVICE_ATTR(uevent_test, (S_IWUGO), NULL, sys_uevent_test_sii6400);
static DEVICE_ATTR(nv_in, (S_IRUGO), sys_read_nv_sii6400, NULL);
static DEVICE_ATTR(nv_out, (S_IWUGO), NULL, sys_write_nv_sii6400);
static DEVICE_ATTR(nv_offset, (S_IWUGO), NULL, sys_set_nv_data_offset_sii6400);
static DEVICE_ATTR(nv_size, (S_IWUGO), NULL, sys_set_nv_data_size_sii6400);
