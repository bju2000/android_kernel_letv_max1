 ...
 *   dev_attr_state
 */
static DEVICE_ATTR(connect, ((S_IWUGO) | (S_IRUGO)),
...
static struct device_attribute dev_attr_cec_out =
	__ATTR(out, (S_IWUGO), NULL, set_sii6400_wihd_cec_out);
...
static struct device_attribute dev_attr_my_connect_timeout =
	__ATTR(connect_timeout, ((S_IRUGO) | (S_IWUGO)),
...
static DEVICE_ATTR(join, ((S_IRUGO) | (S_IWUGO)),
...
static DEVICE_ATTR(scan_duration, ((S_IRUGO) | (S_IWUGO)),
			get_sii6400_wihd_wvan_scan_duration,
			set_sii6400_wihd_wvan_scan_duration);
static DEVICE_ATTR(scan_interval, ((S_IRUGO) | (S_IWUGO)),
...
static struct device_attribute dev_attr_recv_filter =
	__ATTR(recv_filter, ((S_IRUGO) | (S_IWUGO)),
