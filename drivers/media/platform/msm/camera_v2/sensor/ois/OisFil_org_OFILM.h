...
/*the time and date : 2014/6/4 18:02:30*/
/*FC filename : LC898122_V0009_03_LiteOnbase*/
/*fs,23438Hz*/
/*LSI No.,LC898122*/
/*Comment,*/

/* 8bit */
OISINI_OFILM__ const struct STFILREG_OFILM	CsFilReg_OFILM[]	= {
		{ 0x0111,	0x00},		/*00,0111*/
		{ 0x0113,	0x00},		/*00,0113*/
		{ 0x0114,	0x00},		/*00,0114*/
		{ 0x0172,	0x00},		/*00,0172*/
...
/* 32bit */
OISINI_OFILM__ const struct STFILRAM_OFILM	CsFilRam_OFILM[]	= {
		...
		{ 0x1083,	0x39D0B900},		/*39D0B900,1183,-68dB,invert=0*/
#else
		{ 0x1083,	0x38D1B700},		/*38D1B700,1183,-80dB,invert=0*/
#endif
		...
		{ 0x10CC,	0x3E044C00},		/*3E044C00,10CC,LBF,11Hz,34Hz,-8dB,fs/1,invert=0*/
		{ 0x10CD,	0xBE0318C0},		/*BE0318C0,10CD,LBF,11Hz,34Hz,-8dB,fs/1,invert=0*/
		{ 0x10CE,	0x3F7F3F00},		/*3F7F3F00,10CE,LBF,11Hz,34Hz,-8dB,fs/1,invert=0*/
		...
		{ 0x11CC,	0x3E044C00},		/*3E044C00,11CC,LBF,11Hz,34Hz,-8dB,fs/1,invert=0*/
		{ 0x11CD,	0xBE0318C0},		/*BE0318C0,11CD,LBF,11Hz,34Hz,-8dB,fs/1,invert=0*/
		{ 0x11CE,	0x3F7F3F00},		/*3F7F3F00,11CE,LBF,11Hz,34Hz,-8dB,fs/1,invert=0*/
...
/* 32bit */
OISINI_OFILM__ const struct STFILRAM_OFILM	CsFilRam_3m2[]	= {
		{ 0x1000,	0x3F800000},		/*3F800000,1000,0dB,invert=0*/
		{ 0x1001,	0x3F800000},		/*3F800000,1001,0dB,invert=0*/
		{ 0x1002,	0x00000000},		/*00000000,1002,Cutoff,invert=0*/
		{ 0x1003,	0x3F800000},		/*3F800000,1003,0dB,invert=0*/
		...
		{ 0x10D8,	0x00000000},		/*00000000,10D8,Through,30dB,fs/1,invert=0*/
		{ 0x10D9,	0x00000000},		/*00000000,10D9,Through,30dB,fs/1,invert=0*/
		{ 0x10DA,	0x3F6B6900},		/*3F6B6900,10DA,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x10DB,	0xBFDCC0C0},		/*BFDCC0C0,10DB,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x10DC,	0x3FDCC0C0},		/*3FDCC0C0,10DC,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x10DD,	0x3F585DC0},		/*3F585DC0,10DD,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x10DE,	0xBF43C700},		/*BF43C700,10DE,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x10E0,	0x3DE75400},		/*3DE75400,10E0,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x10E1,	0x3DE75400},		/*3DE75400,10E1,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x10E2,	0x3F462B00},		/*3F462B00,10E2,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x10E3,	0x00000000},		/*00000000,10E3,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x10E4,	0x00000000},		/*00000000,10E4,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x10E5,	0x3F800000},		/*3F800000,10E5,0dB,invert=0*/
		{ 0x10E8,	0x3F800000},		/*3F800000,10E8,0dB,invert=0*/
		{ 0x10E9,	0x00000000},		/*00000000,10E9,Cutoff,invert=0*/
		{ 0x10EA,	0x00000000},		/*00000000,10EA,Cutoff,invert=0*/
		...
		{ 0x11D8,	0x00000000},		/*00000000,11D8,Through,30dB,fs/1,invert=0*/
		{ 0x11D9,	0x00000000},		/*00000000,11D9,Through,30dB,fs/1,invert=0*/
		{ 0x11DA,	0x3F6B6900},		/*3F6B6900,11DA,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x11DB,	0xBFDCC0C0},		/*BFDCC0C0,11DB,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x11DC,	0x3FDCC0C0},		/*3FDCC0C0,11DC,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x11DD,	0x3F585DC0},		/*3F585DC0,11DD,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x11DE,	0xBF43C700},		/*BF43C700,11DE,PKF,800Hz,-10dB,3,fs/1,invert=0*/
		{ 0x11E0,	0x3DE75400},		/*3DE75400,11E0,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x11E1,	0x3DE75400},		/*3DE75400,11E1,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x11E2,	0x3F462B00},		/*3F462B00,11E2,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x11E3,	0x00000000},		/*00000000,11E3,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x11E4,	0x00000000},		/*00000000,11E4,LPF,950Hz,0dB,fs/1,invert=0*/
		{ 0x11E5,	0x3F800000},		/*3F800000,11E5,0dB,invert=0*/
		{ 0x11E8,	0x3F800000},		/*3F800000,11E8,0dB,invert=0*/
		{ 0x11E9,	0x00000000},		/*00000000,11E9,Cutoff,invert=0*/
		{ 0x11EA,	0x00000000},		/*00000000,11EA,Cutoff,invert=0*/
